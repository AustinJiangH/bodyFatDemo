var app = new Vue({
    ...
    methods: {
        ...
        check: function (category) {
            ...
            a = (this.gender == "m" || this.gender == "f") && this.validNum(this.age) && this.validNum(this.height) && this.validNum(this.weight);
            b = this.validNum(this.chest) && this.validNum(this.wrist) && this.validNum(this.hip);
            c = this.validNum(this.neck) && this.validNum(this.abdomen) && this.validNum(this.forearm);
            ...
            if (this.check(category)) {
                if (this.measure == "m") {
                    switch (category) {
                        ...
                        case 3:
                            this.bodyfat = -48.0072504350801 + 1.27253573079652 * this.hip + -0.00297215797092711 * this.height * this.hip + 0.0216282944397805 * this.abdomen * this.neck + -0.0239823087192233 * this.hip * this.neck + 0.00654955084837439 * this.height * this.forearm + -0.0491607870492823 * this.forearm * this.wrist
                            break;
                    }
