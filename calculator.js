    ...
    methods: {
        ...
        check: function (category) {
            ...
            if (this.measure = "m") {
                ...
                this.wrist = Number(this.wrist);
                this.hip = Number(this.hip);

                // advanced
                this.adiposity = Number(this.adiposity);
                this.neck = Number(this.neck);
                this.abdomen = Number(this.abdomen);
                this.thigh = Number(this.thigh);
                this.knee = Number(this.knee); 
                this.ankle = Number(this.ankle);
                this.biceps = Number(this.biceps);
                this.forearm = Number(this.forearm);
            }else if(this.measure = "i"){
                // basic
                this.age = Number(this.age);
                this.weight = Number(this.weight) * 0.453592;
                this.height = Number(this.height) * 2.54;

                // common
                this.chest = Number(this.chest) * 2.54;
                this.wrist = Number(this.wrist) * 2.54;
                this.hip = Number(this.hip) * 2.54;

                // advanced
                this.adiposity = Number(this.adiposity);
                this.neck = Number(this.neck) * 2.54;
                this.abdomen = Number(this.abdomen) * 2.54;
                this.thigh = Number(this.thigh) * 2.54;
                this.knee = Number(this.knee) * 2.54; 
                this.ankle = Number(this.ankle) * 2.54;
                this.biceps = Number(this.biceps) * 2.54;
                this.forearm = Number(this.forearm) * 2.54;
            }
